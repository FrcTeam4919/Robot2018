...
import org.usfirst.frc4919.Frankenbot.commands.*;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
import edu.wpi.first.wpilibj.Joystick;
import edu.wpi.first.wpilibj.buttons.*;
import org.usfirst.frc4919.Frankenbot.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        winchButton = new JoystickButton(joystick1, 1);
        winchButton.whileHeld(new WinchLift());
        releaseClampButton = new JoystickButton(joystick1, 1);
        releaseClampButton.whileHeld(new ReleaseClamp());
        clampButton = new JoystickButton(joystick1, 1);
        clampButton.whileHeld(new Clamp());
        lowerArmButton = new JoystickButton(joystick1, 1);
        lowerArmButton.whileHeld(new LowerArm());
        liftArmButton = new JoystickButton(joystick1, 1);
