...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Lean Backward", new LeanBackward());
        SmartDashboard.putData("Lean Forward", new LeanForward());
